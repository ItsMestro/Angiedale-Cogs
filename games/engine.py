...
class GameEngine(Database):
    ...
    async def build_embed(self, msg, settings, win, total, bonus):
        ...
        bal_msg = ("**Remaining Balance:** {} {}").format(humanize_number(balance), currency)
        embed = discord.Embed()
        embed.title = ("{} Casino | {}").format(settings["Settings"]["Casino_Name"], self.game)
        ...
        if win:
            ...
            end = ("Sorry, you didn't win anything.\n{}").format(bal_msg)
